...
public class D_switch {
    ...
    public void testSimpleSwitchStatement(){
        ...
        * [switch 문 표현식]
        * switch(비교할 변수){
        *    case 비교값1 : 비교값 1과 일치하는 경우 실행할 문구; break;
        *    case 비교값2 : 비교값 2와 일치하는 경우 실행할 문구; break;
        *    case 비교값3 : 비교값 3과 일치하는 경우 실행할 문구; break;
        *    default : case 모두에 해당하지 않는 경우 실행할 문구; break;
        * }
        *
        *
