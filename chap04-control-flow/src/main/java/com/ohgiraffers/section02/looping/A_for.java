...
public class A_for {
    ...
    public void testForStatement() {
        ...
        System.out.println("sum2 = " + sum2); // 반복하지 않을 내용이기 때문에 'for'안에 포함안됨
    ...
    public void testForExample2() {
        ...
        Scanner scr = new Scanner(System.in);
        System.out.println("두개의 수 를 입력해주세요 : ");
        int su = scr.nextInt();
        int su2 = scr.nextInt();
        ...
        if (su > su2) {
            for (int i = su2; (su2) <= (su); su2++) {
                sum3 += su2;
            }
        } else {
            for (int i = su; (su) <= (su2); su++) {
                sum3 += su;
            }
...
public void testForExample3 () {
    ...
    int start = scr2.nextInt();
    System.out.println("끝 숫자를 입력해주세요 : ");
    int end = scr2.nextInt();
