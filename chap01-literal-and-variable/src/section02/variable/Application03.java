...
public class Application03 {
    public static void main(String[] args) {
        ...
        * 또한 규칙에 맞는 올바른 변수명을 찾는 것이 좋은 프로그래밍의 첫 단추이다.
        * */
        ...
        * 1-3. 변수명은 대/소문자를 구분한다. (자바는 대소문자를 입력하게 구분하는 언어이다.)
        * 1-4. 변수명은 숫자로 시작할 수 없다. (시작하는 것만 불가능하고 섞어서 사용하는 건 가능하다.)
        * 1-5. 특수기호는 '_'와 '$' 만 사용 가능하다.
        *
        * */

        // 동일한 범위 내 에서는 동일한 변수명을 가질 수 없다.
        int age = 20;
        // int age = 10;
        ...
        * */
        ...
        // 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두번째 시작 단어는 대문자. (Camel)
        int maxAge = 10;
        int MaxAge = 10;

        // 단어와 단어 사이의 연결은 언더스코어로 하지 않는다. (Snake)
        String user_name;
        String userName;
