...
public class Application {
    public static void main(String[] args) {
        ...
        * //객체를 생성하게 되면 관리를 해야 하는데, 그렇지 않기 위해서 그냥 있는것을 사용!!
        * */


        // 별도의 import 없이도 사용할 수 있음.
        // import java.lang * (*은 전체의 의미)
        ...
        // 원하는 난수를 발생시키는 방법
        // Math.random() -> 0~0.999999999999999... 사이 값을 랜덤으로 생성

        System.out.println("난수 발생 : " + (Math.random()));
        // System.out.println("난수 발생 : " + (int)(Math.random( *10) +1 )); -> 이렇게도 표현 가능!!

        // Random 클래스 사용
        Random random = new Random(); //language 안에 있는게 아니기 때문에 import가 들어감
